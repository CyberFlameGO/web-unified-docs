...
- `HCP_CLIENT_ID`          - The HCP client ID of a HashiCorp Cloud Platform service principal that Packer can use to
authenticate to an HCP Packer Registry.

- `HCP_CLIENT_SECRET`      - The HCP client secret of the HashiCorp Cloud Platform service principal that Packer
